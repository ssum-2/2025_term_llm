...
if __name__ == "__main__":
    ...
    # FILEPATH = sorted(os.listdir('./data'))[0]
    ...
    config = RunnableConfig(recursion_limit=100, configurable={"thread_id": "TeddyNote-Parser"})
    ...
    retrieve_and_check_result = retrieve_and_check("디지털 정부혁신의 주요 목표는 무엇인가요?")
